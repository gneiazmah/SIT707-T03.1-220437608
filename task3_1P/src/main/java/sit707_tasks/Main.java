...
public class Main 
{
    ...
    {   
        ...
        /*
         * February 28 in a leap year should increment to February 29.
         */
        System.out.println("February 28 in a leap year should increment to February 29.");
        ...
        /*
         * February 29 in a leap year should increment to March 1.
         */
        System.out.println("February 29 in a leap year should increment to March 1.");
        date = new DateUtil(29, 2, 2020);
        System.out.println(date);
        date.increment();
        System.out.println(date);
    }
